...
Чтобы вернуть (отменить) оплаченный заказ. Нужно перейти в редактирование заказа и в статусе заказа выбрать выбранный статус в настройках модуля:  
![0](images/img9.png)  
После чего будет отправлен refund запрос на возврат оплаты. Также возрат оплаты будет произведен автоматически, если будет отменен или удален заказ в ЛК сайта или в редактирование заказа. 
